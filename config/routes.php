...
Router::prefix('api', function ($routes) {
    ...
    $routes->resources('Package');
    $routes->resources('Packagefeatures');
    $routes->resources('Paymentway');
    $routes->resources('Productfeatures');
    $routes->resources('Subscriptionduration');
