 ...
 *
 */
class SubcatsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_indexes' => [
            'subcats_fk0' => ['type' => 'index', 'columns' => ['category_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'subcats_fk0' => ['type' => 'foreign', 'columns' => ['category_id'], 'references' => ['categories', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public $records = [
        [
            ...
            'created' => '2018-09-09 15:19:21',
            'modified' => '2018-09-09 15:19:21'
        ],
    ];
}
