 ...
 *
 */
class ProductfavsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'amount' => ['type' => 'integer', 'length' => 150, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public $records = [
        [
            ...
            'amount' => 1,
            'product_id' => 1,
            'created' => '2018-09-09 17:05:51',
            'modified' => '2018-09-09 17:05:51'
        ],
    ];
}
