...
class SlidersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'design_id' => ['type' => 'string', 'length' => 250, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public $records = [
        [
            ...
            'design_id' => 'Lorem ipsum dolor sit amet',
            'created' => '2018-09-09 15:22:41',
            'modified' => '2018-09-09 15:22:41'
        ],
    ];
}
