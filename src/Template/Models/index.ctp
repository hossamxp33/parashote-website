		...
		<div class="panel-body">
			...
			<?php foreach ($models as $i => $model): ?>
				<tr>
					...
					<td>
						<?php echo h($model->to_display_timezone('created')); ?>
					</td>
					<td>
						<?php echo h($model->to_display_timezone('modified')); ?>
					</td>
					<td class="actions">
						<?php 
...
// 						echo $this->Form->postLink('<span class="glyphicon glyphicon-trash"></span> ' . __d('alaxos', 'delete'), ['action' => 'delete', $model->id], ['confirm' => __('Are you sure you want to delete # {0}?', $model->id), 'escape' => false]);
						...
						<?php 
						echo $this->Html->link('<span class="glyphicon glyphicon-search"></span>', ['action' => 'view', $model->id], ['class' => 'to_view', 'escape' => false]);
						echo '&nbsp;&nbsp;';
						echo $this->Html->link('<span class="glyphicon glyphicon-pencil"></span>', ['action' => 'edit', $model->id], ['escape' => false]);
						echo '&nbsp;&nbsp;';
						echo $this->Form->postLink('<span class="glyphicon glyphicon-trash"></span>', ['action' => 'delete', $model->id], ['confirm' => __('Are you sure you want to delete # {0}?', $model->id), 'escape' => false]);
						?>
					</td>
				</tr>
			<?php endforeach; ?>
