...
<div class="models form">
    ...
    <fieldset>
        <legend><?= ___('copy model') ?></legend>
        
        <div class="panel panel-default">
            <div class="panel-heading">
            <?php
            echo $this->Navbars->actionButtons(['buttons_group' => 'edit', 'model_id' => $model->id]);
            ?>
            </div>
            <div class="panel-body">
            
            <?php
            echo $this->AlaxosForm->create($model, ['class' => 'form-horizontal', 'role' => 'form', 'novalidate' => 'novalidate']);
