...
<div class="subcats form">
    
    <fieldset>
        <legend><?= ___('edit subcat') ?></legend>
        
        <div class="panel panel-default">
            <div class="panel-heading">
            <?php
            echo $this->Navbars->actionButtons(['buttons_group' => 'edit', 'model_id' => $subcat->id]);
            ?>
            </div>
            <div class="panel-body">
            
            <?php
            echo $this->AlaxosForm->create($subcat, ['class' => 'form-horizontal', 'role' => 'form', 'novalidate' => 'novalidate']);
