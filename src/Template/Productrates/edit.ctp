...
<div class="productrates form">
    
    <fieldset>
        <legend><?= ___('edit productrate') ?></legend>
        
        <div class="panel panel-default">
            <div class="panel-heading">
            <?php
            echo $this->Navbars->actionButtons(['buttons_group' => 'edit', 'model_id' => $productrate->id]);
            ?>
            </div>
            <div class="panel-body">
            
            <?php
            echo $this->AlaxosForm->create($productrate, ['class' => 'form-horizontal', 'role' => 'form', 'novalidate' => 'novalidate']);
