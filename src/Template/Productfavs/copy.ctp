...
<div class="productfavs form">
    
    <fieldset>
        <legend><?= ___('copy productfav') ?></legend>
        
        <div class="panel panel-default">
            <div class="panel-heading">
            <?php
            echo $this->Navbars->actionButtons(['buttons_group' => 'edit', 'model_id' => $productfav->id]);
            ?>
            </div>
            <div class="panel-body">
            
            <?php
            echo $this->AlaxosForm->create($productfav, ['class' => 'form-horizontal', 'role' => 'form', 'novalidate' => 'novalidate']);
