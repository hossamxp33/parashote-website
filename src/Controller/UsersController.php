    ...
    */
    ...
    public function view($id = null)
    {
        $user = $this->Users->get($id, [
            'contain' => ['Deliveryrates', 'Favourite', 'Orders', 'Storerates', 'UserActivities', 'UserContacts', 'UserDetails', 'UserEmailRecipients', 'UserEmailSignatures', 'UserEmailTemplates', 'UserSocials']
        ]);
        $this->set('user', $user);
